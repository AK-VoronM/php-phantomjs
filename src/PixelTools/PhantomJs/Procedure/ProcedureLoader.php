...
use PixelTools\PhantomJs\Exception\NotExistsException;
...
class ProcedureLoader implements ProcedureLoaderInterface
{
     ...
     * Procedure factory.
     *
     * @var \PixelTools\PhantomJs\Procedure\ProcedureFactoryInterface
     * @access protected
     */
     ...
     * @throws \PixelTools\PhantomJs\Exception\NotExistsException
     */
