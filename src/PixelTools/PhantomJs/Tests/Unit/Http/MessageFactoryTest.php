 ...
 */
namespace PixelTools\PhantomJs\Tests\Unit\Http;

use PixelTools\PhantomJs\Http\MessageFactory;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    {
        $this->assertInstanceOf('\PixelTools\PhantomJs\Http\MessageFactory', MessageFactory::getInstance());
    }
    ...
    public function testCanCreateRequest()
    {
        ...
        $this->assertInstanceOf('\PixelTools\PhantomJs\Http\Request', $messageFactory->createRequest());
    }
    ...
    public function testCanCreateCaptureRequest()
    {
        ...
        $this->assertInstanceOf('\PixelTools\PhantomJs\Http\CaptureRequest', $messageFactory->createCaptureRequest());
    }
    ...
    public function testCanCreateResponse()
    {
        ...
        $this->assertInstanceOf('\PixelTools\PhantomJs\Http\Response', $messageFactory->createResponse());
    }
...
/** +++++++++++++++++++++++++++++++++++ **/
     ...
     *
     * @access protected
     * @return \PixelTools\PhantomJs\Http\MessageFactory
     */
