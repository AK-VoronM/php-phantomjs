...
use PixelTools\PhantomJs\Exception\InvalidMethodException;
use PixelTools\PhantomJs\Procedure\InputInterface;
    ...
    implements RequestInterface, InputInterface
{
     ...
     * @throws \PixelTools\PhantomJs\Exception\InvalidMethodException
     */
    public function setMethod($method)
    {
        $method     = strtoupper($method);
        $reflection = new \ReflectionClass('\PixelTools\PhantomJs\Http\RequestInterface');
